          ...
          this.axios
            .get(
              "https://cors-anywhere.herokuapp.com/" +
                ...
                this.current +
                "&per_page=26&type=CAR&make=*&model=*&search_id=&search_query=&year_from=1920&year_to=2021&sort_field=&sort_order=&sales_type=buy_it_now&distance=*&destination_zip=&location_state=*&location_city=*&primary_damage=normal+wear+%26+tear*&title_name=*&exterior_color=*&odometer_min=*&odometer_max=*"
            )
            .then(response => {
